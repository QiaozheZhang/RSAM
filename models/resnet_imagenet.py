...
# ResNet }}}
def KResNet18(pretrained=False):
    return KResNet(KBasicBlock, [2, 2, 2, 2], 1000)


def KResNet50(pretrained=False):
    return KResNet(KBottleneck, [3, 4, 6, 3], 1000)


def KResNet101(pretrained=False):
    return KResNet(KBottleneck, [3, 4, 23, 3], 200)
    #return ResNet(get_builder(), Bottleneck, [3, 4, 23, 3], 1000)


def KWideResNet50_2(pretrained=False):
    return KResNet(
        KBottleneck, [3, 4, 6, 3], num_classes=1000, base_width=64 * 2
    )


def KWideResNet101_2(pretrained=False):
    return KResNet(
        KBottleneck, [3, 4, 23, 3], num_classes=1000, base_width=64 * 2
    )
